...
from ..automation_trigger.automation_trigger_cli import automation
...
class MainCLI:
    def __init__(self, config_id: str = None, debug: bool = False):
        ...
        self.automation_service = AutomationTriggerService(self.api_client)  # Add automation service
